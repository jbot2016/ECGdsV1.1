 ...
 * ============================================================================
 */
//jb note: ADC can only take positive voltage values, important consideration that needs to be payed attention to.
...
CSL_Status    status;
    ...
    param.SysClkDiv = sysClkDvsor; //0x1869; //was ox0b 0x1869; sample at 500Hz
    //param.SysClkDiv = 0x1869; 

...

{
	...
	CSL_FSET(CSL_SPI_REGS->SPICC2, CSL_SPI_SPICC2_CLKEN_SHIFT, 
		CSL_SPI_SPICC2_CLKEN_SHIFT, CSL_SPI_SPICC2_CLKEN_DISABLED);
	//CSL_FINST(CSL_SPI_REGS->SPICC2, SPI_SPICC2_CLKEN, DISABLED);
	CSL_FINST(CSL_SPI_REGS->SPICC2, SPI_SPICC2_RST, RELEASE);
	...
	/* Set Clock  division */
	CSL_FINS(CSL_SPI_REGS->SPICC1, SPI_SPICC1_DCLK_DIV, sysClkDiv);
	...
	CSL_FINS(CSL_SPI_REGS->SPICR1, SPI_SPICR1_FLEN, spiHwConfig->frLen-1);

	/* Enable or Disable word count IRQ */
	CSL_FINS(CSL_SPI_REGS->SPICR1, SPI_SPICR1_WIRQ, spiHwConfig->wcEnable);

	for(delay = 0; delay < 16; delay++);
	/* Enable the serial Data clock */
	CSL_SPI_REGS->SPICC2 =
	      (Uint16)(CSL_SPI_SPICC2_CLKEN_ENABLED << CSL_SPI_SPICC2_CLKEN_SHIFT);

	/* Enable or Disable frame count IRQ */
	CSL_FINS(CSL_SPI_REGS->SPICR1, SPI_SPICR1_FIRQ, spiHwConfig->fcEnable);

	/* Select active CS for transfer */
	spicmd2 |= spiHwConfig->csNum << CSL_SPI_SPICR2_CSNUM_SHIFT;
	CSL_FSET(CSL_SPI_REGS->SPICR2, 15, 0, spicmd2); 
	...
	{
		case CSL_SPI_SPICR2_CSNUM_CS0:
			CSL_FINS(CSL_SPI_REGS->SPIDC1, SPI_SPIDC1_DD0,
											spiHwConfig->dataDelay);
			CSL_FINS(CSL_SPI_REGS->SPIDC1, SPI_SPIDC1_CSP0,
											spiHwConfig->csPol);
			CSL_FINS(CSL_SPI_REGS->SPIDC1, SPI_SPIDC1_CKP0,
											spiHwConfig->clkPol);
			CSL_FINS(CSL_SPI_REGS->SPIDC1, SPI_SPIDC1_CKPH0,
											spiHwConfig->clkPh);
			break;
		case CSL_SPI_SPICR2_CSNUM_CS1:
			CSL_FINS(CSL_SPI_REGS->SPIDC1, SPI_SPIDC1_DD1,
											spiHwConfig->dataDelay);
			CSL_FINS(CSL_SPI_REGS->SPIDC1, SPI_SPIDC1_CSP1,
											spiHwConfig->csPol);
			CSL_FINS(CSL_SPI_REGS->SPIDC1, SPI_SPIDC1_CKP1,
											spiHwConfig->clkPol);
			CSL_FINS(CSL_SPI_REGS->SPIDC1, SPI_SPIDC1_CKPH1,
											spiHwConfig->clkPh);
			break;
		case CSL_SPI_SPICR2_CSNUM_CS2:
			CSL_FINS(CSL_SPI_REGS->SPIDC2, SPI_SPIDC2_DD2,
											spiHwConfig->dataDelay);
			CSL_FINS(CSL_SPI_REGS->SPIDC2, SPI_SPIDC2_CSP2,
											spiHwConfig->csPol);
			CSL_FINS(CSL_SPI_REGS->SPIDC2, SPI_SPIDC2_CKP2,
											spiHwConfig->clkPol);
			CSL_FINS(CSL_SPI_REGS->SPIDC2, SPI_SPIDC2_CKPH2,
											spiHwConfig->clkPh);
			break;
		case CSL_SPI_SPICR2_CSNUM_CS3:
			CSL_FINS(CSL_SPI_REGS->SPIDC2, SPI_SPIDC2_DD3,
											spiHwConfig->dataDelay);
			CSL_FINS(CSL_SPI_REGS->SPIDC2, SPI_SPIDC2_CSP3,
											spiHwConfig->csPol);
			CSL_FINS(CSL_SPI_REGS->SPIDC2, SPI_SPIDC2_CKP3,
											spiHwConfig->clkPol);
			CSL_FINS(CSL_SPI_REGS->SPIDC2, SPI_SPIDC2_CKPH3,
											spiHwConfig->clkPh);
			break;
		default:
